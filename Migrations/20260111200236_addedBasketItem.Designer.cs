...
namespace Pronia.Migrations
{
    ...
    [Migration("20260111200236_addedBasketItem")]
    partial class addedBasketItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pronia.Models.BasketItem", b =>
                {
                    ...
                    b.ToTable("BasketItems", t =>
                        {
                            t.HasCheckConstraint("CK_BasketItem_Count", "[Count] >= 1");
                        });
                });
                    ...
                    b.ToTable("Products", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Product_Rating", "[Rating] >= 1 AND [Rating] <= 5");
                        });
                });
